...
import {ExamRuleApi} from "@/api/school/rule/examRule";


defineOptions({ name: 'ExamRuleList' })
...
const getList = async () => {
  loading.value = true
  try {
    const data = await ExamRuleApi.getExamRulePage(queryParams)
...
const handleDelete = async (id: number) => {
  try {
    ...
    // 发起删除
    await ExamRuleApi.deleteExamRule(id)
